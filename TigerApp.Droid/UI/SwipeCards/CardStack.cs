...
namespace TigerApp.Droid.UI.SwipeCards
{
    ...
    public class CardStack : RelativeLayout
    {
        ...
        {
            _cardAnimator.Discard(direction, new AnimatorListenerAdapterAnonymousInnerClass(this, direction, TopView), duration);
        }
        ...
        private class AnimatorListenerAdapterAnonymousInnerClass : AnimatorListenerAdapter
        {
            ...
            public override void OnAnimationEnd(Animator arg0)
            {
                ...
                _outerInstance.ViewCollection[_outerInstance.ViewCollection.Count - 1].SetOnTouchListener(_outerInstance._onTouchListener);
        ...
        private sealed class DragListener : DragGestureDetector.IDragListener
        {
            ...
            public bool OnDragEnd(MotionEvent e1, MotionEvent e2)
            {
                ...
                {
                    if (_outerInstance._canSwipe)
                        _outerInstance._cardAnimator.Discard(direction, new AnimatorListenerAdapterAnonymousInnerClass2(this, direction, _outerInstance.TopView));
            ...
            private class AnimatorListenerAdapterAnonymousInnerClass2 : AnimatorListenerAdapter
            {
                ...
                public AnimatorListenerAdapterAnonymousInnerClass2(DragListener outerInstance, int direction, View topView)
                {
                    _outerInstance = outerInstance;
                    _direction = direction;
                    _topView = topView;
                ...
                public override void OnAnimationEnd(Animator arg0)
                {
                    ...
                    _outerInstance._outerInstance._cardEventListener.Discarded(_outerInstance._outerInstance._index, _direction);
                    _outerInstance._outerInstance.DiscardedEvent?.Invoke(_outerInstance._outerInstance._index, _direction);
                    ...
                    _outerInstance._outerInstance.ViewCollection[_outerInstance._outerInstance.ViewCollection.Count - 1].SetOnTouchListener(_outerInstance._outerInstance._onTouchListener);
                }
            }
        ...
        private global::Android.Database.DataSetObserver _dataObserver;

        private class DataSetObserver : global::Android.Database.DataSetObserver
        {
        ...
        public View TopView
        {
            get
            {
                return ((ViewGroup)ViewCollection[ViewCollection.Count - 1]).GetChildAt(0);
            }
        }
