...
{
    [Register("EditProfileMissionViewController")]
    public class EditProfileMissionViewController : BaseReactiveViewController<IEditProfileMissionViewModel>
    {
        public EditProfileMissionViewController()
        {
        }
        ...
        protected override void LayoutViews()
        {
            ...
            title.Text = Constants.Strings.EditProfileMissionPageTitle;
            ...
            var mainImg = UIImage.FromBundle("edi_profile_01");
            ...
            wrapper.AddConstraints(new NSLayoutConstraint[]
            {
                ...
                NSLayoutConstraint.Create(pointsImageView, NSLayoutAttribute.Height, NSLayoutRelation.Equal, wrapper, NSLayoutAttribute.Height, 0.45f, 0),
                ...
                NSLayoutConstraint.Create(pointsImageView, NSLayoutAttribute.Bottom, NSLayoutRelation.Equal, wrapper, NSLayoutAttribute.Bottom, 1, -5),
            ...
            message.AttributedText = new NSAttributedString(Constants.Strings.EditProfileMissionPageMessage,
            ...
            completeCommand.TouchUpInside += delegate { PresentViewController(new EditProfileViewController(), true, null); };
